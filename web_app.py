...
st.markdown("""
    ...
    h1, h2, h3 {
        color: #4834d4 !important; /* Глубокий синий */
...
def color_sugar(val):
    try:
        f_val = float(val)
        if f_val > 7.2: return 'background-color: #ffcccc; color: #cc0000; font-weight: bold;'
        if 4.0 <= f_val <= 7.2: return 'background-color: #d4edda; color: #155724; font-weight: bold;'
